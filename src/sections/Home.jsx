...
export default function Home() {
  return (
    <div className="landing flex w-full h-screen text-black" id="home">
      <div className="leftdiv w-full absolute md:static md:w-1/2 md:text-[2.5vw] text-xl flex flex-col justify-center md:items-start items-center text-center md:text-left px-12 leading-none">
