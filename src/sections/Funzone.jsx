      ...
      <div className="mid w-full flex items-center justify-center games">
        <div className="game-wrap flex justify-center items-center flex-col py-12 leading-[4vw] px-2 text-[#043927]">
          ...
          <a
            ...
            className="border-solid border-2 border-green-800 mt-2 rounded-full px-2 py-1 bg-green-100 w-full text-center"
          >
            <span className="game3 md:text-[3vw] text-xl">Duck game</span>
          </a>
        </div>
      </div>
